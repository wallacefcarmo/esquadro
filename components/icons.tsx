...
export function IconProgramacao({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24">
...
export function IconApontamento({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24">
...
export function IconMaquinas({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24">
